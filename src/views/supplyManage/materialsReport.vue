  ...
  <div class="main orderStyle">
    ...
    <div class="main-content">
      <el-row style="padding-top:10px">
        <div class="title-line">物料出入库明细表</div>
      </el-row>
      <hr />
      <el-row class="top15"
        ...
        <el-col>
          <div class="seachStyle top10">
            <label for
                   class="font14 fontWeight">出入库类别：</label>
          ...
          <div class="seachStyle top10">
            <label for
                   class="font14 fontWeight">单据类型：</label>
            <el-select placeholder="请选择">
              <el-option value="全部"></el-option>
              <el-option value="采购入库"></el-option>
              <el-option value="其他入库"></el-option>
              <el-option value="移库入库"></el-option>
              <el-option value="盘溢入库"></el-option>
              <el-option value="退货出库"></el-option>
              <el-option value="领用出库"></el-option>
              <el-option value="其他出库"></el-option>
              <el-option value="移库出库"></el-option>
              <el-option value="盘损出库"></el-option>
              <el-option value="领料出库"></el-option>
          ...
          <div class="seachStyle top10">
           ...
           <div class="seachStyle top10">
            <label for
                   class="font14 fontWeight">供应商：</label>
            <el-select placeholder="请选择">
              <el-option value="全部"></el-option>
