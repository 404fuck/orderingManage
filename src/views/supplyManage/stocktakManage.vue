        ...
        <el-col>
          ...
          <span class="select-region font14">
            ...
            >
              ...
              <el-option value="日盘点"></el-option>
              <el-option value="月盘点"></el-option>
              <el-option value="周盘点"></el-option>
            </el-select>
          </span>
          <span class="select-region font14">
            状态
        ...
        <el-col>
          <div class="table">
            ...
            >
              ...
              <el-table-column prop="mobile_inf" label="仓库名称"></el-table-column>
              <el-table-column prop="class_name" label="盘点时间"></el-table-column>
