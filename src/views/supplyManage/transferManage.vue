        ...
        <el-col>
          <div class="table">
            ...
            >
              ...
              <el-table-column prop="class_name" label="移出仓库"></el-table-column>
              <el-table-column prop="class_name" label="移入仓库"></el-table-column>
              <el-table-column prop="class_name" label="移库时间"></el-table-column>
