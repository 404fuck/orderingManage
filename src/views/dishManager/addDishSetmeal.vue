 ...
 * @LastEditTime: 2021-03-23 17:46:13
 * @LastEditors: Please set LastEditors
 * @Description: 新建套餐
 * @FilePath: \sjoyOrderingManage\src\views\dishManager\addDishSetmeal.vue
-->
<template>
    <div class="main dishStyle">
        ...
        <div class="main-content addDish-content">
            <el-row style="padding-top: 20px">
                <div class="title-line">{{ $t("sidebar.xinjiantaocang") }}</div>
            </el-row>
            <hr />
        ...
        */
        ...
        uploadInfo(back) {
            ...
            if (this.ruleForm.weight_spec == 3) {
                let tempArr = [];
                let suitsArr = [];
                this.ruleForm.suits_original_price = String(this.originalPrice);
            ...
            this.request.addDish(this.ruleForm, function (res) {
                if (res.code == "1") {
                    that.toast.success(that.$t("addSucc"));
                    if (back) {
                        that.$router.push({
