 ...
 * @LastEditTime: 2021-03-23 17:45:26
 * @LastEditors: Please set LastEditors
 * @Description: 新建菜品
 * @FilePath: \sjoyOrderingManage\src\views\dishManager\addDish.vue
-->
<template>
    <div class="main dishStyle">
        ...
        <el-breadcrumb separator="/">
            <el-breadcrumb-item>
                <router-link tag="a" to="/dishList" class="crumbsLink">{{ $t("sidebar.caipingliebiao") }}</router-link>
            </el-breadcrumb-item>
            <el-breadcrumb-item>
                <span style="color: #232426">{{ $t("addDish.addDish") }}</span>
            </el-breadcrumb-item>
        </el-breadcrumb>
        <div class="main-content addDish-content">
            <el-row style="padding-top: 20px">
                <div class="title-line">{{ $t("addDish.addDish") }}</div>
            </el-row>
            <hr />
            <el-row style="padding: 30px 50px">
                ...
                >
                    ...
                    <!-- 菜品分类 -->
                    <el-form-item :label="$t('addDish.dishType_')" prop="dish_second_name">
                        <el-select
                    ...
                    <el-form-item>
                        <el-row style="margin-left: 120px;margin-top:20px;">
                            ...
                            <el-button
                                ...
                                >{{ $t("addDish.saveAndBegin") }}</el-button
                            >
                            <el-button
                                class="cancelBtn"
                                type="primary"
...
export default {
    computed: {
        ...
        weightSpec(){
            return this.ruleForm.weight_spec;
        },
    },
    data() {
        return {
            ...
            ruleForm: {
                ...
                weight_spec: "0", //0:普通菜，1：称重菜，2：规格菜,3：固定套餐 4:自选套餐
            },
                ...
                if (res.code == "1") {
                    if (res.data != null) {
                        ...
                        if(res_data[1].list.length==0){
                            that.toast.info(that.$t('addDish.addDishMsg'));
                            return false;
                        }else{
        ...
        */
        ...
        uploadInfo(back) {
            ...
            if(this.ruleForm.additional_ref_type=="2" &&this.selectFeedingList.length > 0){
                this.ruleForm.addtional_list = this.stringutils.simpleCopy(this.selectFeedingList); 
            }else{
            ...
            this.okLoading = true;
            that.request.addDish(that.ruleForm, function (res) {
    ...
    created() {
        ...
        if (curentStore) {
            ...
            this.getPackList();
            this.getPrint();
            // console.log(this.businessModel.additional_switch);
            //售卖时间--自定义时间
            let date = new Date();
    ...
    watch:{
        weightSpec(newVal, oldVal) {
            if (newVal==1) {
                this.ruleForm.unit_type = 'kg';
            }else{
